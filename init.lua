...
vim.opt.relativenumber = true -- Show relative line numbers for easy motions

-- Tabs & indentation
vim.opt.tabstop = 4 -- A tab character = 4 spaces
vim.opt.softtabstop = 4 -- Tab key inserts 4 spaces
vim.opt.shiftwidth = 4 -- Indent commands use 4 spaces
...
-- Line wrapping
vim.opt.wrap = false -- Do not wrap long lines; scroll horizontally

-- Swap, backup, and undo
vim.opt.swapfile = false -- Disable swap files
vim.opt.backup = false -- Disable backup files
vim.opt.undodir = os.getenv 'HOME' .. '/.vim/undodir' -- Directory for persistent undo
vim.opt.undofile = true -- Enable persistent undo

-- Search behavior
vim.opt.hlsearch = false -- Do not highlight search results permanently
...
vim.opt.isfname:append '@-@' -- Allow `@-@` in file paths for commands like gf

-- Performance
vim.opt.updatetime = 50 -- Faster update events for CursorHold, LSP, etc.

-- Coding style / visual guides
...
-- File explorer (simple + universal)
...
-- Keep cursor centered when moving/searching
...
-- [[ Basic Autocommands ]]
local ddritzenhoff = vim.api.nvim_create_augroup('ddritzenhoff', {})
